...
public class NERDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String serializedClassifier = "stanford-ner-2015-01-30/classifiers/english.all.3class.distsim.crf.ser.gz";
...
*/
      for (String str : example) {
        String output = classifier.classifyToString(str, "tsv", false);
